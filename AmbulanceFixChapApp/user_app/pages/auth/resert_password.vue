      ...
      <aside class="hidden w-64 text-gray-100 bg-gray-800 lg:block">
        <div class="flex flex-col justify-between h-full">
          ...
          <nav class="py-5 p-7" style="margin-top: 90px;">
            <ul class="py-4">
              <li>
                <nuxt-link to="/auth/dashboard" class="block px-6 py-2 shadow-md bg-white-700 hover:bg-gray-700">Dashboard</nuxt-link>
              </li>
              <br>
              <li>
              ...
              <li>
                <nuxt-link to="/" class="block px-6 py-2 hover:bg-gray-700">Your-Routes</nuxt-link>
              </li>
            </ul>
          </nav>
        ...
        <div class="p-4">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="py-5 shadow-sm p-7" style="margin-top: 30px;background-color:white">
              ...
              <div class="py-5">
                <button type="submit" class="flex justify-center p-5 px-4 py-3 text-sm font-medium text-white transition duration-150 ease-in-out bg-teal-500 border border-transparent rounded-md w-600 hover:bg-blue-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">
                  Reset Now
                </button>
              </div>
            </div>
...
function resetPassword(email, oldPassword, newPassword) {
  ...
  axios.post('http://127.0.0.1:8000/api/update-passwordv6', {
    email: email,
