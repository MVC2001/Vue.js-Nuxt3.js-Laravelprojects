                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./resertPasswordv1b.php">Resert</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./allnvigilators.php">View</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./all_questionnairesDetails.php">Manage</a></li>
                        </ul>
                    </li>
                ...
                <div class="row">
                            ...
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Invigilators</div>
                                     <?php
                           $count = mysqli_query($connect,"select user_id from users where role='invigilator'") or die(mysqli_error($connect));
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Total of QuestionnairesDetails</div>
                                      <?php
