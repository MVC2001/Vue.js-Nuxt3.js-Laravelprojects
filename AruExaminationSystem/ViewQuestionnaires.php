                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./allQuestionnaireDetils.php">Back-now</a></li>
                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <span><button type="button" class="btn btn-primary mb-2"><a href="./allQuestionnaireDetils.php" style="color:white">Cancel</button></a></span>
                                    </form>
                                </div>
                            </div>
                        </div>
