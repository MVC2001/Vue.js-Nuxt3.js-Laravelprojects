...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['booklet_id']) && !empty($_POST['booklet_id'])) {
        ...
        $deleteQuery = mysqli_query($connect, "DELETE FROM `assignedbooklets` WHERE `booklet_id` = $booklet_id");
        
        if ($deleteQuery) {
            // 	booklet_id deleted successfully
            header('Location: allBookletsInfo.php'); // Redirect to 	booklets page
            exit();
        } else {
            // Error deleting user
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:#032B58">BookletDetails Assigned to    Examination Coordinators For Invigilation here</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:150px;background-color:#032B58"><a href="addNewInfoToExamsCoord.php">Add-New-Info</a></button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        ...
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all = "SELECT * FROM `assignedbooklets` ORDER BY booklet_id DESC";
                 ...
                 if ($number > 0) {
                     while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td><?php echo $count ?></td>
                                ...
                                <td>
                                    <a href="updateBookletInfoForExamsCoord.php?booklet_id=<?php echo $row['booklet_id'] ?>">
                                    <button class="btn btn-warning btn-sm">
                                    <i class="fa fa-pencil"></i></button> </a>
                                    <span>
                                    <form action="" method="POST">
                                       <input type="hidden" name="booklet_id" value="<?php echo $row['booklet_id']; ?>">
