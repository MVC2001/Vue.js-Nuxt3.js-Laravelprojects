...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id']) && !empty($_POST['id'])) {
        ...
        $deleteQuery = mysqli_query($connect, "DELETE FROM `invassignedbookletsdetails` WHERE `id` = $id");
        
        if ($deleteQuery) {
            // 	booklet_id deleted successfully
            header('Location: 	allInvBookletsDetails.php'); // Redirect to 	booklets page
            exit();
        } else {
            // Error deleting user
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:#032B58">BookletDetails Assigned to Invigilators For Invigilation here</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:150px;background-color:#032B58"><a href="addNewInfoForInvBookletsDetails.php">Add-New-Info</a></button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                         ...
                                         <?php 
                 $count=1;
                 $select_all = "SELECT * FROM `invassignedbookletsdetails` ORDER BY id DESC";
                            ...
                            <td><?php echo $count ?></td>
                                ...
                                <td><?php echo $row['Dept']; ?></td>
                                    <td><?php echo $row['quantity']; ?></td>
                                      <td><?php echo $row['coseCode']; ?></td>
                                      <td><?php echo $row['program']; ?></td>
                                       <td><?php echo $row['created_at']; ?></td>
                                <td>
                                    <a href="updateAsssInvBD.php?id=<?php echo $row['id'] ?>">
