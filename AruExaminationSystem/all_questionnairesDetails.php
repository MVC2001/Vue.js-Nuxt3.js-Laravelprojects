...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id']) && !empty($_POST['id'])) {
        ...
        $deleteQuery = mysqli_query($connect, "DELETE FROM `allquestionnairesdetails` WHERE `id` = $id");
        
        if ($deleteQuery) {
            // 	booklet_id deleted successfully
            header('Location: all_questionnairesDetails.php'); // Redirect to 	booklets page
            exit();
        } else {
            // Error deleting user
            echo "Error allInvBookletsDetails.";
        }
    } else {
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./QAO_dashboard.php">Back-now</a></li>
                    </li>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:#032B58"> All QuestionnaireDetails to mange the conduct of ue</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        <thead style="color:white;background-color:#032B58">
                                            <tr>
                                               <th style="color:white">No#</th>
                                                <th style="color:white">EvaluatorsName</th>
                                                <th style="color:white">CourseCode</th>
                                                <th style="color:white">Program</th>
                                                <th  style="color:white">VenueNo</th>
                                                <th style="color:white">Students</th>
                                                
                                                   <th style="color:white">WithExpired ID</th>
                                        ...
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all = "SELECT * FROM `allquestionnairesdetails` ORDER BY id DESC";
                 ...
                 if ($number > 0) {
                     while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td><?php echo $count ?></td>
                                <td><?php echo $row['evaluatorsName']; ?></td>
                                <td><?php echo $row['courseCode']; ?></td>
                                <td><?php echo $row['program']; ?></td>
                                    <td><?php echo $row['venueNo']; ?></td>
                                      
                                         <td><?php echo $row['studentsFoundWithId']; ?></td>
                                          <td><?php echo $row['studentsFoundWithExpiredId']; ?></td>
                                       <td><?php echo $row['created_at']; ?></td>
                                <td>
                                    <a href="EditquestionnairesDetails.php?id=<?php echo $row['id'] ?>">
