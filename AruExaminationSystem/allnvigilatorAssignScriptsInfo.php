                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h4>All assigned scripts  for Invigilation here</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:200px;background-color:#032B58"><a href="./assignScriptsToInvig.php">AddNew-information</a></button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        <thead   style="color:white;background-color:#032B58">
                                            <tr>
                                               <th style="color:white">No#</th>
                                                <th style="color:white">Invigilator ID</th>
                                        ...
                                        <tbody style="color:#032B58" >
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `assscript` ORDER BY script_id   DESC";
