        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label first">ALL REQUESTS FOR PERMISSION</li><hr>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>All request for-permission</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Dept</th>
                                                 <th>School</th>
                                                  <th>Reason</th>
                                                  <th>Comment for DirectorOfstuService</th>
                                                  <th>Status</th>
                                                   <th>ApprovedAT</th>
                                                <th>Created AT</th>
                                                <th>Actions</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Buttons for delete, update, and download -->
                                                          <a href="approveHerev2.php?id=<?php echo $result['id']; ?>" class="btn btn-info btn-sm">Approve</a>
