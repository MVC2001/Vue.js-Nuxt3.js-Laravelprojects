...
function addUser($connect,$user_id,$school_id,$department_id,$courseCode,$program, $quantity,$description) {
    ...
    $checkEmailQuery = mysqli_query($connect, "SELECT * FROM `assingbookletstoexaminer` WHERE `booklet_id` = '$booklet_id'");
    ...
    $insertQuery = mysqli_query($connect, "INSERT INTO `assingbookletstoexaminer` (`user_id`,`school_id`,`department_id`,`courseCode`,`program`,`quantity`, `description`) VALUES ('$user_id','$school_id','$department_id','$courseCode','$program','$quantity', '$description')");
    if ($insertQuery) {
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./allExaminerAssignedBookletInfo.php">Back-now</a></li>
                    </li>
                                          ...
                                          <div class="col-sm-6">
                                           <input type="text" class="form-control" name="user_id"  placeholder="Enter user  ID here">
                                            ...
                                            <div class="col-sm-6 mt-2 mt-sm-0">
                                                <input type="text" class="form-control" name="school_id"  placeholder="Enter School id here">
                                            </div>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                          <div class="col-sm-4">
                                           <input type="text" class="form-control" name="department_id"  placeholder="Enter department ID here">
                                            </div>
