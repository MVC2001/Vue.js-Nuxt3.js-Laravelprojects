...
function addUser($connect, $quantity,$description) {

    // Check if  already exists
    $checkEmailQuery = mysqli_query($connect, "SELECT * FROM `bookletdetails` WHERE `booklet_id` = '$booklet_id'");
    ...
    $insertQuery = mysqli_query($connect, "INSERT INTO `bookletdetails` (`quantity`, `description`) VALUES ('$quantity', '$description')");
    if ($insertQuery) {
...
if (isset($_POST['add-function'])) {
    ...
    $result = addUser($connect,$quantity,$description);
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4 style="color:#032B58">Add new bookletDetail here</h4>
                                <!-- Success message -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <div class="form-row">
                                          <div class="col-sm-6">
                                           <input type="number" class="form-control" name="quantity" name="text" placeholder="Enter quantity here">
                                            </div>
