...
function updateUser($connect, $booklet_id , $confirmation) {
    ...
    $updateQuery = mysqli_query($connect, "UPDATE `assignedbooklets` SET `confirmation`='$confirmation' WHERE `booklet_id`='$booklet_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    header("Location: assignedBooklets.php");
    exit();
}
?>
