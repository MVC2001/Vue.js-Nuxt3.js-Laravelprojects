...
function updateUser($connect, $booklet_id , $confirmation) {
    ...
    $updateQuery = mysqli_query($connect, "UPDATE `assingbookletstoexaminer` SET `confirmation`='$confirmation' WHERE `booklet_id`='$booklet_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    header("Location: examinerAssignedBookletsInfo.php");
    exit();
}
?>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./examiner.php">Back-now</a></li>
                    </li>
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            <label for="day" >ID</label>
                                                <input name="user_d" value="<?php echo $row['user_id']; ?>" required type="text" class="form-control" placeholder="">
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">
                                             <label for="School" >School D</label>
