...
function updateUser($connect, $booklet_id , $confirmation) {
    
    // Update Detail in the database
    $updateQuery = mysqli_query($connect, "UPDATE `assignbooklets` SET `confirmation`='$confirmation' WHERE `booklet_id`='$booklet_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    $result = updateUser($connect, $booklet_id , $confirmation);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: InAssignedBooks.php");
    exit();
}
?>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                                <div class="basic-form">
                                    ...
                                    <?php
                $select = "select * from assignbooklets where booklet_id  = '" .$_GET['booklet_id']. "'";
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            <label for="day" >Name</label>
                                                <input name="fullName" value="<?php echo $row['user_id']; ?>" required type="text" class="form-control" placeholder="">
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        <div class="form-row">
                                          ...
                                          <option value="Not-comfirm">Not-Comfirm</option>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <span> <button type="button" class="btn btn-primary mb-2"><a href="./examinerAssignedBookletsInfo.php" style="color:white">Cancel</button></a></span>
                                    </form>
                                </div>
                            </div>
                        </div>
