...
function updateUser($connect, $script_id , $comfirmation) {
    
    // Update Detail in the database
    $updateQuery = mysqli_query($connect, "UPDATE `assignedscripts` SET `comfirmation`='$comfirmation' WHERE `script_id`='$script_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    $result = updateUser($connect, $script_id , $comfirmation);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: assignedScripts.php");
    exit();
}
?>
                                ...
                                <div class="basic-form">
                                        <div class="form-row">
                                            ...
                                            <label for="user_id" >User ID</label>
                                                <input name="user_id" value="<?php echo $row['user_id']; ?>" required type="text" class="form-control" placeholder="" readonly>
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">
                                        ...
                                        <div class="form-row">
                                          ...
                                          <label for="ended_at" >Department ID</label>
                                             ...
                                             <label for="venueNo" >Quantity</label>
                                                 <input name="venueNo" value="<?php echo $row['quantity']; ?>" required type="text" class="form-control" placeholder="" readonly>
                                            </div>
                                        </div>
