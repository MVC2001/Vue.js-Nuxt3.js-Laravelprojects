...
function updateUser($connect, $script_id, $confirmation) {
    ...
    $updateQuery = mysqli_query($connect, "UPDATE `assscript` SET `confirmation`='$confirmation' WHERE `script_id`='$script_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    $script_id= $_GET['script_id']; // assuming id is sent via GET
    $confirmation = $_POST['confirmation'];

    $result = updateUser($connect, $script_id , $confirmation);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: assignedScriptsV1.php");
    exit();
}
?>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                                <div class="basic-form">
                                    ...
                                    <?php
                $select = "select * from assscript where script_id = '" .$_GET['script_id']. "'";
                                        ...
                                        <div class="form-row">
                                            ...
                                            <label for="day" >Name</label>
                                             ...
                                             <label for="School" >School</label>
                                                 <input name="School" value="<?php echo $row['school_id']; ?>" required type="text" class="form-control" placeholder="">
                                            </div>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        <div class="form-row">
                                          ...
                                          <div class="col-sm-6 mt-2 mt-sm-0">
                                          <label for="ended_at" >Department</label>
                                                <input name="department" value="<?php echo $row['department_id']; ?>" required type="text" class="form-control" placeholder="">
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">
                                        ...
                                        <div class="form-row">
                                          ...
                                          <label for="totalStudents" >Description</label>
                                             ...
                                             <label for="bookletsUsed" >Comfirm here</label>
                                                 <select type="text" name="confirmation" class="form-control">
                                          <option value="None-user">--Selct-----to Comfirm--------</option>
                                          <option value="confirmed">Comfirm</option>
                                          <option value="Not-confirm">Not-Comfirm</option>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <span> <button type="button" class="btn btn-primary mb-2"><a href="./assignedBooklets.php" style="color:white">Cancel</button></a></span>
                                    </form>
                                </div>
                            </div>
                        </div>
