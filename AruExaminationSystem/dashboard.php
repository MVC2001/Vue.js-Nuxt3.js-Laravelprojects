            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                      ...
                      <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">UserHas-Role</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./userRole.php">View</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                      ...
                      <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Role-It-Has-Permission</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./rolePermission.php">View</a></li>
                        </ul>
                    </li>

                     <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Permission</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./permission.php">View</a></li>
                        </ul>
                    </li>


                      <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">School</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./schools.php">View</a></li>
                        </ul>
                    </li>
                    

                      <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right"></i><span class="nav-text">Department</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./department.php">View</a></li>
                        </ul>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Permission</div>
                                      <?php
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"> <i class="fa fa-dashboard"></i>NAN</div>
                                </div>
                            </div>
                        </div>
                        <!-- /# card -->
