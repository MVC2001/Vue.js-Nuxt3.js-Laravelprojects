...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['department_id']) && !empty($_POST['department_id'])) {
        ...
        $deleteQuery = mysqli_query($connect, "DELETE FROM `department` WHERE `department_id` = $department_id");
        
        if ($deleteQuery) {
            // User deleted successfully
            header('Location: schools.php'); // Redirect to users page
            exit();
        } else {
            // Error deleting user
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:150px;background-color:#032B58"><a href="./addDepartment.php">AddDepartment</a></button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                            ...
                                            <tr>
                                               <th style="color:white">No#</th>
                                                ...
                                                <th style="color:white">Location</th>
                                                  <th style="color:white">Ceated_at</th>
                                        ...
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `department` ORDER BY department_id DESC";
