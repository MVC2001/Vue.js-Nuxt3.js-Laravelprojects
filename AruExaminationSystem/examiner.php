                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./resertPasswordv1e.php">Resert</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./examinerAssignedBookletsInfo.php">View</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-12 col-sm-612">
                        <div class="card">
                            <div class="stat-widget-two text-succcess card-body">
                              <b><h4 style="color:green;font-size:35px">EXAMINATION EXAMINER DASHBOARD</h4>
                            </div>
                        </div>
                    </div>
