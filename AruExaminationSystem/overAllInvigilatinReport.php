                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-dark btn-block" style="width:200px;background-color:#032B58"><a href="./submittReport.php">CreateNew-Report</a></button>
                            </div>
                            <div class="card-body">
                                        ...
                                        <thead style="color:white;background-color:#032B58">
                                            <tr>
                                               <th style="color:white">No#</th>
                                                ...
                                                <th style="color:white">TotalStudents</th>
                                                <th style="color:white">BookletsUsed</th>
                                                <th style="color:white">unUsedBooklets</th>
                                                <th style="color:white">UsedScripts</th>
                                                <th style="color:white">unUsedScripts</th>
