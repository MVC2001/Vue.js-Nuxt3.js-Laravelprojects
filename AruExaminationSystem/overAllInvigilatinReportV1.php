            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                     ...
                     <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="fa fa-hand-o-right" style="background-color:#273D55"></i><span class="nav-text">GenerateReport</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./printReort.php">generate now</a></li>
                    </li>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h4>Invigilation Report here</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        <thead style="color:white;background-color:#032B58">
                                            <tr>
                                               <th style="color:white">No#</th>
                                                ...
                                                <th style="color:white"style="color:white">Program</th>
                                                <th style="color:white">Comfirmation</th>
                                                <th style="color:white">ComfirmHere</th>
                                            </tr>
                                        </thead>
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `invigilation_reportv1` ORDER BY id    DESC";
                     ...
                     while($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <td><?php echo $count ?></td>
                                ...
                                <td><button class="btn btn-success"><?php echo $row['comfirmation']; ?></button></td>
                                 <td><a href="comfirmAssignedBookletsV3.php?id=<?php echo $row['id'] ?>"><button class="btn btn" style="background-color:#273D55">View&Comfirm</button></a></td>
                            </tr>
                            <?php $count++?>
                        <?php }} ?>
                                        </tbody>             
