                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>All  Quality Assurance Officers</h4>
                        </div>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        ...
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `users` where role='quality_assurance_officer' ORDER BY user_id DESC";
                            ...
                            <td><?php echo $count ?></td>
                                <td><?php echo $row['fullName']; ?></td>
                                 <td><button class="btn btn-success"><?php echo $row['role']; ?></button></td>
                                  <td><?php echo $row['email']; ?></button></td>
