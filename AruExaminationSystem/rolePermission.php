                                ...
                                <div class="table-responsive">
                                    <table id="example2" class="display table-bordered" style="width:100%">
                                        <thead style="color:white;background-color:#032B58">
                                            <tr>
                                               <th style="color:white">No#</th>
                                                <th style="color:white">Role ID</th>
                                                <th style="color:white">Permission ID</th>
                                        ...
                                        <tbody style="color:#032B58">
                                         ...
                                         <?php 
                 $count=1;
                 $select_all_users = "SELECT * FROM `role_permission` ORDER BY role_id DESC";
