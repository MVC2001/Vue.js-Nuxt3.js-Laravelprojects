...
function updateUser($connect, $id, $fullName, $School, $Dept, $quantity, $coseCode, $program) {
    
    // Update Detail in the database
    $updateQuery = mysqli_query($connect, "UPDATE `invassignedbookletsdetails` SET  `fullName`='$fullName',`School`='$School',`Dept`='$Dept',`quantity`='$quantity',`coseCode`='$coseCode',`program`='$program' WHERE `id`='$id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    // Pass the correct number of arguments to updateUser function
    $result = updateUser($connect, $id, $fullName, $School, $Dept, $quantity, $coseCode, $program);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: allInvBookletsDetails.php");
    exit();
}
?>
...
<head>
    ...
    <title>Update bookletDetail</title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./booklets.php">Back-now</a></li>
                    </li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                                <div class="basic-form">
                                    ...
                                    <?php
                $select = "select * from invassignedbookletsdetails where id  = '" .$_GET['id']. "'";
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                        <div class="form-row">
                                          ...
                                          <div class="col-sm-6 mt-2 mt-sm-0">
                                                <input name="coseCode" value="<?php echo $row['coseCode']; ?>" required type="text" class="form-control" placeholder="">
                                            </div>
                                             <div class="col-sm-6 mt-2 mt-sm-0">
