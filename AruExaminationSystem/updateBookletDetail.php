...
function updateUser($connect, $booklet_id, $quantity, $description) {
    
    // Update bookletDetail in the database
    $updateQuery = mysqli_query($connect, "UPDATE `bookletdetails` SET  `quantity`='$quantity', `description`='$description' WHERE `booklet_id`='$booklet_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    // Pass the $connect parameter to updateUser function
    $result = updateUser($connect, $booklet_id, $quantity, $description);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: booklets.php");
    exit();
}
?>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                                <div class="basic-form">
                                    ...
                                    <?php
                $select = "select * from bookletdetails where booklet_id  = '" .$_GET['booklet_id']. "'";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                        ...
                                        <span> <button type="button" class="btn btn-primary mb-2"><a href="./booklets.php" style="color:white">Cancel</button></a></span>
                                    </form>
                                </div>
                            </div>
                        </div>
