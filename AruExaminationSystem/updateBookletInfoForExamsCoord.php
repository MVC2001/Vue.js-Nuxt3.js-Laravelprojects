...
function updateUser($connect,$booklet_id,$user_id,$school_id,$department_id,$quantity,$description) {
    
    // Update bookletDetail in the database
    $updateQuery = mysqli_query($connect, "UPDATE `assignedbooklets` SET  `user_id`='$user_id',`school_id`='$school_id',`department_id`='$department_id',`quantity`='$quantity', `description`='$description' WHERE `booklet_id`='$booklet_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    //update function
    $result = updateUser($connect, $booklet_id,$user_id,$school_id,$department_id,$quantity,$description);
    if (strpos($result, 'successfully') !== false) {
        $_SESSION['success_message'] = $result;
    } else {
        $_SESSION['error_message'] = $result;
    }
    header("Location: allBookletsInfo.php");
    exit();
}
?>
                ...
                <div class="row">
                    <div class="col-xl-6 col-xxl-12">
                                <div class="basic-form">
                                    ...
                                    <?php
                $select = "select * from assignedbooklets where 	booklet_id  = '" .$_GET['booklet_id']. "'";
