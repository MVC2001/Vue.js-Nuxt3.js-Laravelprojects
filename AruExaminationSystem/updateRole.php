...
function updateUser($connect,$role_id,$role,$description) {
    

    $updateQuery = mysqli_query($connect, "UPDATE `role` SET  `role`='$role', `description`='$description' WHERE `role_id`='$role_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
   $role_id = $_GET['role_id']; 
    ...
    $result = updateUser($connect,$role_id, $role, $description);
