...
function updateUser($connect,$user_id, $fullName,$role, $school_id,$department_id) {
   

    // Update user in the database
    $updateQuery = mysqli_query($connect, "UPDATE `users` SET  `fullName`='$fullName',`role`='$role',`school_id`='$school_id',`department_id`='$department_id' WHERE `user_id`='$user_id'");
    if ($updateQuery) {
...
if (isset($_POST['update-function'])) {
    ...
    $result = updateUser($connect,$user_id, $fullName,$role,$school_id,$department_id);
