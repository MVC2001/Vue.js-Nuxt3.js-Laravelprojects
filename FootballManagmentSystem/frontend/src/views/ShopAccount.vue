    ...
    <div class="dashboard">
      <div class="flex mt-16">
        ...
        <div class="w-1/2 md:w-1/4 lg:w-1/5 min-h-screen text-white bg-gray-800 text-white p-4 fixed" style="background-color:teal;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
          ...
          <div class="mb-4">
            <p class="text-2xl font-bold">SHOP-ITEMS</p>
          </div>
          <ul class="space-y-2">
            <hr>
            <li>
        ...
        <div class="w-1/2 md:w-3/4 lg:w-4/5 p-4 ml-auto relative" style="background-color:white">
          ...
          <main>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <RouterLink to="/addNewItem"><button class="bg-teal-500 text-white px-4 py-2 rounded-full absolute  right-4" style="background-color: teal;">Add New Item</button></RouterLink>
                <br>
        ...
        <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
            ...
            <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
                ...
                <tbody>
                    <tr v-for="shop in ourshop" :key="shop.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                          <img :src="getImageUrl(shop.image)" :alt="shop.name + ' Image'" class="max-w-full h-auto" style="width: 150px;height:110px;border-radius:95%;">
                        </td>

                        <td class="px-6 py-4 text-right">
                            <button @click="deleteItem(shop.id)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline" style="background-color: teal;">Delete</button>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    console.error(error);
      ...
      async deleteItem(id) {
        if (confirm('Are you sure you want to delete this item?')) {
          try {
            await axios.delete(`/api/ourshop/${id}`);
