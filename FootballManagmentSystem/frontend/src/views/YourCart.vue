            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
              ...
              <form class="w-full max-w-sm"  @submit.prevent="submitForm">
                ...
                <div class="flex justify-end space-x-2" style="margin-left: 800px;">
                  <button  @click="addToCart" type="button" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" style="margin-top: 40px;">
                    Place Order
                  </button>
                  <a href="/ourshop">
