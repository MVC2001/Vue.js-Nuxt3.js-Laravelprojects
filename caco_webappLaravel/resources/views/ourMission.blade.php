...
<head>
  ...
  <link href="assets/css/style.css" rel="stylesheet">
    ...
    <!-- Style CSS -->
    <link href="css1/stylem.css" rel="stylesheet">
    <!-- owl-carousel -->
                ...
                <div class="row">
                    <div class="col-xl-10 col-lg-10 offset-md-1 col-md-10 col-sm-12 col-12  mb60">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="par">
                                    <p>..With love and care, we are Care and Comfort Organization
                                        (CACO). We promise to bring comfort and health to every corner of
                                        our community. We will continue to work diligently to bring
                                        sustainable changes using natural wisdom, strengthening our culture,
                                        and providing healthcare services that touch our hearts and make our
                                        community a better place to live.</p>
                                </div>
                            </div>
                        </div>
                    </div>
