    ...
    <div>
        <div class="flex flex-col justify-center min-h-screen px-6 py-12 bg-gray-50 sm:px-6 lg:px-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <h3 class="font-extrabold text-center" style="font-weight:bold;color:yellowgreen;font-size:30px">LOGO</h3>
                    ...
                    <form @submit.prevent="login">
                        ...
                        <div class="mt-6">
                            <span class="block w-full rounded-md shadow-sm">
                                <button :disabled="loading" type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md hover:bg-blue-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">
