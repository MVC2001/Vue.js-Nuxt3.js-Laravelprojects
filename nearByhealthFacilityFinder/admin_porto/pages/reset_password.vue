<template>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex flex-col justify-between h-full">
          ...
          <nav class="py-5 p-7" style="margin-top: 60px;">
            <ul class="py-4">
              ...
              <li>
                <nuxt-link to="/" class="block px-6 py-2 hover:bg-gray-700">Admin dashboard</nuxt-link>
              </li>
            </ul>
          </nav>
          <!-- End of sidebar content -->
      ...
      <main class="flex-1">
        ...
        <div class="p-4">
          ...
          <form @submit.prevent="handleSubmit">
            ...
            <div class="py-5 shadow-sm p-7" style="margin-top: 30px;background-color:white">
              ...
              <div class="py-3">
                <button type="submit" class="flex justify-center h-10 p-5 px-5 py-3 mt-8 text-sm font-medium text-white transition duration-150 ease-in-out bg-gray-800 border border-transparent rounded-md w-600 hover:bg-blue-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">
                  Reset Now
                </button>
              </div>
            </div>
        ...
        <div v-if="showSuccessAlert" class="p-4 mb-4 text-center text-green-700 bg-gray-800 border-l-4 border-green-500 rounded">
